...
/**
 * Soft target: Cloth Config may be absent at runtime. @Pseudo skips apply when the class is missing.
 */
@Pseudo
@Mixin(targets = "me.shedaniel.clothconfig2.api.AbstractConfigEntry", remap = false)
