...
public final class BiomeInfo implements Comparable<BiomeInfo>, IBiomeSoundProvider {
    ...
    public BiomeInfo(final int version, final Identifier id, final String name, BiomeTraits traits, Biome biome) {
        ...
        if (biome != null) {
            ...
            var backgroundMusic = attributes.applyModifier(
                    net.minecraft.world.attribute.EnvironmentAttributes.BACKGROUND_MUSIC,
                    net.minecraft.world.attribute.EnvironmentAttributes.BACKGROUND_MUSIC.defaultValue());
