...
public final class Randomizer implements IRandomizer {
    ...
    private static IRandomizer getRandomizer() {
        try {
            ...
            // NeoForge ModuleClassLoader can duplicate RandomGenerator SPI providers, which fails
            // RandomGeneratorFactory with ExceptionInInitializerError (an Error, not Exception).
            ...
            try {
                ...
                Library.LOGGER.warn("Unable to list RandomGenerator factories");
            }
        }
