...
public class CompassOverlay extends AbstractOverlay {
    ...
    public void drawTexture(GuiGraphics context, Identifier texture, float x, float y, float u, float v, float width, float height) {
        this.drawTexture(context, texture, x, x + width, y, y + height, width, height, u, v);
    }

    void drawTexture(GuiGraphics context, Identifier texture, float x1, float x2, float y1, float y2, float regionWidth, float regionHeight, float u, float v) {
        this.drawTexturedQuad(context, texture, x1, x2, y1, y2, (float) 0, u, v, regionWidth, regionHeight);
    }

    void drawTexturedQuad(GuiGraphics context, Identifier texture, float x1, float x2, float y1, float y2, float z, float u, float v, float regionWidth, float regionHeight) {
