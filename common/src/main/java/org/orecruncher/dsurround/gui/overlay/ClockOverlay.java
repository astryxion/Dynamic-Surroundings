...
public class ClockOverlay extends AbstractOverlay {
    ...
    public void tick(Minecraft client) {
        ...
        if (this.config.compassAndClockOptions.enableClock && GameUtils.isInGame()) {
            ...
            var angleDegrees = world.environmentAttributes().getDimensionValue(EnvironmentAttributes.SUN_ANGLE) + 180;
            // Wrap
            if (angleDegrees >= 360)
                angleDegrees -= 360;
    ...
    public void render(GuiGraphics context, float partialTick) {
        ...
        TooltipRenderUtil.renderTooltipBackground(context, x - this.renderWidth / 2, y, this.renderWidth, this.renderHeight, null);
