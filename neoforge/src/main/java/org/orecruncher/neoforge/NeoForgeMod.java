...
public final class NeoForgeMod {
    ...
    public void onRegisterGuiLayersEvent(RegisterGuiLayersEvent event) {
        ...
        event.registerBelowAll(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "layer/overlaymanager"),
                (graphics, deltaTracker) -> ContainerManager.resolve(OverlayManager.class).render(graphics, deltaTracker));
    }
